...
.send-carousel{top:calc(50% + 18px)}.belen-widget{bottom:calc(50% + 42px)}.belen-launcher{width:56px;height:56px}.belen-nudge{right:64px;bottom:10px;width:160px}.belen-panel{width:min(300px,calc(100vw - 88px));height:min(650px,calc(100vh - 70px))}.belen-live-frame{aspect-ratio:9/16}
@media(max-width:620px){.send-carousel{top:calc(50% + 16px)}.belen-widget{bottom:calc(50% + 37px)}.belen-launcher{width:48px;height:48px}.belen-nudge{right:56px;bottom:7px;width:140px}.belen-panel{right:65px;width:min(275px,calc(100vw - 70px));height:min(600px,calc(100vh - 70px))}}
