...
.price-track[data-three-slides="polaroid"] .services-slide{grid-template-columns:repeat(3,1fr);grid-template-rows:1fr 1fr}
.services-slide .price-info h2{font-size:9px}.services-slide .price-info strong{font-size:13px;margin-top:5px}.services-slide .price-info small{font-size:7px}
...
.web-work-card{text-decoration:none;color:inherit}.flyer-price-card{cursor:default;text-align:left;padding:0}
