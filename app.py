...
<div class="price-slide"><button class="price-card flyer-price-card" type="button" onclick="document.getElementById('precios-volantes').classList.add('open')"><div class="price-icon blue">📄</div><div class="price-info"><h2>Volantes</h2><strong>$200 c/u</strong><small>500 y 1.000 unidades · tocá para ver características</small></div></button><button class="price-card card-price-card" type="button" onclick="document.getElementById('precios-tarjetas').classList.add('open')"><div class="price-icon pink">💳</div><div class="price-info"><h2>Tarjetas 5×8 cm</h2><strong>$50.000 / $100.000</strong><small>50 / 100 u · tocá para ver características</small></div></button></div></div><div class="dots"><i></i><i></i><i></i><i></i></div>'''
    ...
    if 'id="precios-volantes"' not in html:
        volantes_modal = '<div class="web-modal" id="precios-volantes" role="dialog" aria-modal="true" aria-label="Precios de volantes"><div class="web-box"><div class="web-head"><h2>Precios de volantes</h2><button class="web-close" type="button" aria-label="Cerrar" onclick="document.getElementById(\'precios-volantes\').classList.remove(\'open\')">×</button></div><p class="web-sub">Volantes de ¼ de oficio, aproximadamente 10,8×17,8 cm.</p><div class="inkjet-prices"><div><span>500 unidades</span><b>$200 c/u · $100.000</b></div><div><span>1.000 unidades</span><b>$200 c/u · $200.000</b></div><div><span>Características</span><b>B&N · una sola faz · 4 por hoja oficio</b></div></div></div></div>'
...
/* Los tres accesos flotantes quedan más abajo para no tapar el carrusel. */
.send-carousel{top:calc(50% + 190px)!important}
.belen-widget{bottom:calc(50% - 135px)!important}
@media(max-width:620px){.send-carousel{top:calc(50% + 160px)!important}.belen-widget{bottom:calc(50% - 112px)!important}}
</style>
