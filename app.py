...
<div class="price-slide"><article class="price-card flyer-price-card"><div class="price-icon blue">📄</div><div class="price-info"><h2>Volantes</h2><strong>$200 c/u</strong><small>500 y 1.000 unidades · ¼ oficio (10,8×17,8 cm)</small></div></article><article class="price-card card-price-card"><div class="price-icon pink">💳</div><div class="price-info"><h2>Tarjetas 5×8 cm</h2><strong>$50.000 / $100.000</strong><small>50 / 100 u · mate 300 g · 1 faz color o B&N</small></div></article></div></div><div class="dots"><i></i><i></i><i></i><i></i></div>'''
