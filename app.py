...
def imprenta_ruiz():
    ...
    animated_mascot = '<img class="mascota-float mascota-animada" style="width:125px;max-height:180px" src="https://share.zapia.com/1lff1gcc8yb0dyigx10bja" alt="Mascota animada de Imprenta Ruiz">'
