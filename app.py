...
<div class="belen-widget" id="belenWidget" aria-label="Belen, asistente virtual de Imprenta Ruiz">
  ...
  <button class="belen-launcher" id="belenLauncher" type="button" aria-label="Abrir a Belen, asistente virtual" aria-expanded="false"><img src="/static/belen-asistente.jpg" alt="Belen, asistente virtual de Imprenta Ruiz"></button>
...
(function(){
  ...
  function toggleBelen(force){var open=typeof force==='boolean'?force:!belenPanel.classList.contains('is-open');if(open){belenPanel.classList.add('is-open');belenLauncher.setAttribute('aria-expanded','true');if(belenNudge)belenNudge.style.display='none';if(belenFrame&&!belenFrame.src||belenFrame&&belenFrame.src==='about:blank')belenFrame.src=belenFrame.getAttribute('data-src')}else{belenPanel.classList.remove('is-open');belenLauncher.setAttribute('aria-expanded','false')}}
